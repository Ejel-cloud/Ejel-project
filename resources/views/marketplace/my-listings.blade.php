...
<div class="container py-4">
    ...
    {{-- Filters --}}
    <form method="GET"
          action="{{ route('marketplace.my-listings') }}"
        ...
        <div class="mt-2">
            ...
            <a href="{{ route('marketplace.my-listings') }}" class="btn btn-secondary">❌ Clear</a>
        </div>
    </form>
        ...
        @forelse($listings as $listing)
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            {{ ucfirst($listing->animal_type ?? $listing->animal->type) }}
                        </h5>
                        <p class="text-muted mb-1">City: {{ $listing->city }}</p>
                        <p class="text-muted mb-1">Price: {{ number_format($listing->price) }} SYP</p>
